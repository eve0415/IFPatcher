...
public abstract class Patch implements Opcodes {
    ...
    protected AnnotationNode findAnnotation(final MethodNode targetMethod, final String annotationDesc) {
    ...
    protected InsnNode findReturn(final MethodNode targetMethod) {
        for (final ListIterator<AbstractInsnNode> it = targetMethod.instructions.iterator(); it.hasNext();) {
