...
public class PatchPlantSower extends Patch {
    private final String hook = "com/buuz135/industrial/tile/agriculture/CropSowerTile";
    ...
    protected boolean patch() {
        ...
        newInst.add(
                new FieldInsnNode(GETFIELD, hook, getName("world", "field_145850_b"), "Lnet/minecraft/world/World;"));
        newInst.add(new VarInsnNode(ALOAD, 0));
