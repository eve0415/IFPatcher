...
public class PatchPotionBrewer extends Patch {
    ...
    protected boolean patch() {
        ...
        newInst.add(new FieldInsnNode(GETFIELD, hook, "inputIngredients", "Lnet/ndrei/teslacorelib/inventory/LockableItemHandler;"));
        newInst.add(new MethodInsnNode(INVOKESTATIC, hookClass, "patchIngredientItemsHandler", "(Lnet/ndrei/teslacorelib/inventory/LockableItemHandler;)Lnet/minecraftforge/items/IItemHandler;", false));
